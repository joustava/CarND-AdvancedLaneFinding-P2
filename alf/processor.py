...
def example():
    ...
    # TODO EXPLORE AUTO DETECTION OF POINTS?
    step4_src = cv2.imread(
        './assets/output_images/test5_undistorted_thresholded.jpg')

    tr = Transformer()
    step4_dest = tr.warp(step4_src)
    cv2.imwrite(
        './assets/output_images/test5_undistorted_warped.jpg', step4_dest)

    # 5. PERSPECTIVE TRANSORMATION
